...
let summary = "A monadic web scraping library"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "This is essentially a single-function library which in fact integrates many existing libraries and present several ways to approach web scraping by using different monads"

// List of author names (for NuGet package)
let authors = [ "gusty" ]

// Tags for your project (for NuGet package)
let tags = "FSharp Scraping Web Monad State Linq MonadTransformer"

// File system information
let solutionFile  = "ScrapeM.sln"
